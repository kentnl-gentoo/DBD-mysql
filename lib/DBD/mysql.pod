...
The same applied to Perl 5.005. I am told that DBD::mysql is not
yet in the PPM3 repository. Thus you should use PPM2, whenever
possible. If you have PPM3 only, try
