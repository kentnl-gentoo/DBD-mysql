/* Hej, Emacs, this is -*- C -*- mode!
   ...
   $Id: mysql.xs,v 1.4.2.6 2005/04/22 22:27:31 capttofu Exp $
...
rows(sth)
  ...
  /* fix to make rows able to handle errors and handle max value from 
     affected rows.
     if mysql_affected_row returns a memory error, it's value is 18446744073709551615,
     if mysql_affected_row returns a syntax error, it's value is 18446744073709551614,
     while a (my_ulonglong)-1 is  18446744073709551615, so we have to test against >=  
     (my_ulonglong) -2
  */
